  ...
  >
    ...
    <div ref="sidemenu" class="sidemenu flex flex-col">
      ...
      <NuxtLink
        to="/payment-method"
        class="sidemenu__link mb-2.5"
        :class="$route.name === 'payment-method' ? 'activeRoute' : ''"
        data-theme-bg="bg-gray-1000"
        data-theme-text="text-orange-midlight"
        data-theme-circle="bg-orange-midlight"
        data-index="4"
      >
        <div class="link__title fill-current text-orange-midlight ml-0.5">
          <svg
            id="Layer_2"
            data-name="Layer 2"
            xmlns="http://www.w3.org/2000/svg"
          ...
          <p
            class="sidemenu__label payment transition-all duration-500 ease-in-out"
            :class="collapse ? 'opacity-0' : 'opacity-100 delay-500'"
          >
            Pay Methods
          </p>
...
.sidemenu {
  ...
  .router-link-exact-active .payment {
    color: #e0ad1f;
  }
